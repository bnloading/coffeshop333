...
class UI {
        ...
        <div class="product__footer">
          ...
          <div class="bottom">
            <div class="btn__group">
              <button class="btn addToCart" data-id= ${id} >Қосу</button>
              
            </div>
            <div class="price">${price}тг</div>
          </div>
        </div>
      </div>
    ...
    getButtons() {
        ...
        buttons.forEach(button => {
            ...
            if (inCart) {
                button.innerText = "Қосылды";
                button.disabled = true;
            }

            button.addEventListener("click", e => {
                e.preventDefault();
                e.target.innerHTML = "Қосылды";
